...
def homePage():
    ...
    telLogo = tk.PhotoImage(file="G:/Alireza/Programing/Python/win apps/BPGVideoDownloader/Icon/TelegramLogo.png")
    ...
    gitLogo = tk.PhotoImage(file="G:/Alireza/Programing/Python/win apps/BPGVideoDownloader/Icon/GitHubLogo.png")
...
def openFolder(self):
    ...
    fileSelect = askopenfile(title="Select a movie", filetypes=[('Mp4/Mkv Files', ('*.mp4 *.mkv'))])
